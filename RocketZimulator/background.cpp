...
void background::init_background(){
	this->background_sprite_ = tx_manager_.create_sprite("assets/textures/bg.png");
	this->background_sprite_left_ = tx_manager_.create_sprite("assets/textures/bg.png");
	this->background_sprite_right_ = tx_manager_.create_sprite("assets/textures/bg.png");
